...
import scipy.signal
from torch_utils.ops import upfirdn2d_gradfix, conv2d_gradfix, grid_sample_gradfix
...
class AugmentPipe(torch.nn.Module):
    def __init__(self,
        ...
        self.register_buffer('Hz_geom', upfirdn2d_gradfix.setup_filter(wavelets['sym6']))
    ...
    def forward(self, images, debug_percentile=None):
        ...
        if G_inv is not I_3:
            ...
            # Upsample.
            images = upfirdn2d_gradfix.upsample2d(x=images, f=self.Hz_geom, up=2)
            ...
            # Downsample and crop.
            images = upfirdn2d_gradfix.downsample2d(x=images, f=self.Hz_geom, down=2, padding=-Hz_pad * 2, flip_filter=True)
